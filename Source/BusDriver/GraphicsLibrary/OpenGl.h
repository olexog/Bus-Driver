...
namespace GraphicsLibrary
{
	...
	public:
		...
		void Draw(Scene* scene, vec3 vehiclePosition, quat vehicleRotation, vector<Model*> physicsWheelModels, vector<vec3> positions, vector<quat> rotations, Model* physicsChassisModel, vec3 chassisPosition, quat chassisRotation, Model* wheelModel, Model* chassisModel, vector<Model*> physicsPanelModels, vector<vec3> physicsPanelPositions);
